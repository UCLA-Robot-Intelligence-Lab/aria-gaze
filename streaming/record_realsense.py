...
data = DataRecorder(frame_name="gaze_data_realsense.mp4", coord_name="gaze_data_realsense.npy")
            ...
            if aria.CameraId.Rgb in observer.images:
                ...
                if realsense_image is not None:
                    ...
                    if transformed_x is not None and transformed_y is not None:
                        data.record_frame(realsense_image, (int(transformed_x), int(transformed_y))) # save frame to mp4
                        ...
                        cv2.putText(realsense_image, 'No Transformation Found', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
